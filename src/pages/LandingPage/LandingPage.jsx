...
import webImg from "../../assets/landingpage-services-imgs/web-development.jpg";
import appImg from "../../assets/landingpage-services-imgs/app-development.jpg";
              ...
              <div className="absolute left-0 top-0 w-full p-3 h-full flex items-center justify-center bg-black/60">
                <div className="text-white space-y-3 text-center">
                  ...
                  <p className="description">
                    INVEDA SOLUTIONS is an AI company based in Bengaluru. We
